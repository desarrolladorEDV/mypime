                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <div className="flex justify-between items-center">
                                ...
                                <Button
                                    ...
                                    onClick={(e) => {
                                        ...
                                        const nextValue = currentOptions.length > 0 ? Math.max(...currentOptions) + 1 : 0;
                                        form.setValue("options", currentOptions.concat([nextValue]));
                                    }}>
                                    <Plus />
                                    Agregar
                                </Button>
                            ...
                            <FormDescription>Las opciones del select se incrementan automáticamente.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
